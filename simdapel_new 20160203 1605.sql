...
--
-- Create schema simdapel_new
--

CREATE DATABASE IF NOT EXISTS simdapel_new;
USE simdapel_new;

--
-- Definition of table `bidang`
--
...
--
-- Definition of table `data_inventori`
--
...
--
-- Definition of table `data_kuesioner`
--
...
--
-- Definition of table `data_subjek`
--
...
--
-- Definition of table `permohonan_data_bps`
--
...
--
-- Definition of table `permohonan_data_nonbps`
--
...
--
-- Definition of table `pl_company`
--
...
INSERT INTO `pl_data` (`id`,`kode`,`nama`,`jumlah_media`,`duplikat`,`manual`,`tgl_terima`,`sn`,`media_id`,`license_id`,`jenis_id`,`company_id`,`tgl_expired`,`ket`,`create_time`,`operator_id`,`kontak_id`) VALUES 
 (1,'1001','SYMANTEC Server',1,1,'1001.png','2015-01-01','-',3,2,1,17,'2016-01-01','-','2016-02-01 09:15:29',17,18),
 (2,'1004','Avast Pro Antivirus 6.0.1000',1,1,'1004.pdf','2015-01-01','',4,6,1,20,'2016-01-01','','2016-02-01 09:15:30',17,18),
 (3,'1005','McAfee VirusScan Enterprise 8.5i Plus Patch 6',1,1,'1005.pdf','2015-01-01','',4,6,1,7,'2016-01-01','','2016-02-01 09:15:31',17,18),
 (4,'2001','DPP 2013 Program',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:32',18,18),
 (5,'2002','DPPNRT 2014 Program',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:33',18,18),
 (6,'2003','IBS 2012',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:34',18,18),
 (7,'2004','IHK Online',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:35',18,18),
 (8,'2005','IMK Progam Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:36',18,18),
 (9,'2006','PIPA 2012 Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:37',18,18),
 (10,'2007','PODES 2011 Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:38',18,18),
 (11,'2008','PODES 2014 Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:39',18,18),
 (12,'2009','PPLS 2011 Program',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:40',18,18),
 (13,'2010','PSPK2011 Program',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:41',18,18),
 (14,'2011','PST Aplikasi',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:42',18,18),
 (15,'2012','RPH Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:43',18,18),
 (16,'2013','SAKERNAS 2011 Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:44',18,18),
 (17,'2014','SAKERNAS 2011 Program Updating',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:45',18,18),
 (18,'2015','SAKERNAS 2012 Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:46',18,18),
 (19,'2016','SAKERNAS 2012 Program Updating',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:47',18,18),
 (20,'2017','SAKERNAS 2013 Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:48',18,18),
 (21,'2018','SAKERNAS 2014 Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:49',18,18),
 (22,'2019','SPPLH13 Program',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:50',18,18),
 (23,'2020','SPSS11_5',1,1,NULL,'2015-01-01','-',3,2,2,17,'2016-01-01','-','2016-02-01 09:15:51',18,18),
 (24,'2021','SPTI Program',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:52',18,18),
 (25,'2022','SSN 2012 Program Updating',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:53',18,18),
 (26,'2023','SSN SBH 2012 Program Entri',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:54',18,18),
 (27,'2024','ST2013 Program',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:55',18,18),
 (28,'2025','StatTransfer7',1,1,NULL,'2015-01-01','-',3,2,2,17,'2016-01-01','-','2016-02-01 09:15:56',18,18),
 (29,'2026','STRPBS 2013',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:57',18,18),
 (30,'2027','SUSENAS 2014 Program Entry',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:58',18,18),
 (31,'2028','SUSENAS 2015 Program Updating',1,1,NULL,'2015-01-01','-',3,7,2,17,'2016-01-01','-','2016-02-01 09:15:59',18,18),
 ...
 (91,'2031','dsfsdfs',2,NULL,'2031.xlsx','2016-02-03',NULL,5,2,2,5,'0000-00-00','','2016-02-03 15:20:06',17,NULL);
/*!40000 ALTER TABLE `pl_data` ENABLE KEYS */;


--
-- Definition of table `pl_instalasi`
--
...
--
-- Definition of table `pl_license`
--
...
--
-- Definition of table `pl_transaksi`
--
...
INSERT INTO `user` (`id`,`nip`,`nama`,`username`,`email`,`password`,`remember_token`,`seksi_id`,`role_id`) VALUES 
 (1,'196811051994012001','Ika Novia Satriana SE, MM','ika','','$2y$10$AHABsyePbKWsCKro3R4qb.GvmO5F/ekF2Jo6Q3.S.efhaszh9nZHi','Lfmt7MQPzgFopWemGi4g1uCmDAdk8Fqf4MSC7VxY6KDcyznUhCbwC5OKEVd8',1,3),
 ...
 (17,'197604091999011001','Hakim Azizi S.ST','hakim','hakim@bps.go.id','$2y$10$AHABsyePbKWsCKro3R4qb.GvmO5F/ekF2Jo6Q3.S.efhaszh9nZHi','yN3FNnmaGlTsGDKzkhG2nKjfIc58xpmyrDrtzM9tLkEG5dpOch60qgNvk5v1',17,4),
