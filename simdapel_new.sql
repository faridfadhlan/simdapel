...
CREATE TABLE `data_inventori` (
  ...
  CONSTRAINT `Relationship52` FOREIGN KEY (`operator_id`) REFERENCES `operator` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1267 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `instansi` (`id`,`nama_instansi`) VALUES 
 (1,'BPS Provinsi Kalimantan Barat');
...
CREATE TABLE `pegawai` (
  ...
  PRIMARY KEY (`id`),
  KEY `IX_Relationship63` (`instansi_id`),
  CONSTRAINT `Relationship63` FOREIGN KEY (`instansi_id`) REFERENCES `instansi` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `pegawai` (`id`,`nip`,`nama`,`unit`,`instansi_id`) VALUES 
 (1,'198909202012111001','Muhammad Farid Fadhlan','IPDS',1);
...
CREATE TABLE `permohonan_data_bps` (
  ...
  CONSTRAINT `Relationship60` FOREIGN KEY (`operator_id`) REFERENCES `operator` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `Relationship61` FOREIGN KEY (`status_id`) REFERENCES `status` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `Relationship62` FOREIGN KEY (`pegawai_id`) REFERENCES `pegawai` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `permohonan_data_nonbps` (
  ...
  CONSTRAINT `Relationship58` FOREIGN KEY (`operator_id`) REFERENCES `operator` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `pl_data` (
  ...
  CONSTRAINT `Relationship54` FOREIGN KEY (`operator_id`) REFERENCES `operator` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `Relationship64` FOREIGN KEY (`media_id`) REFERENCES `pl_media` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=551 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
